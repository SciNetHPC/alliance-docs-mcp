...
== General ==
ACPYPE: AnteChamber PYthon Parser interfacE (pronounced as ace + pipe), is a tool written in Python
...
We provide Python wheels for ACPYPE for StdEnv/2020 and StdEnv/2023
in our wheelhouse that you should install into a virtual environment.
...
First the python and openbabel need to be loaded.
We also download a structure file of Adenosine triphosphate (ATP) from PubChem:
