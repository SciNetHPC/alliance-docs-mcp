---
title: "Abaqus/fr"
url: "https://docs.alliancecan.ca/wiki/Abaqus/fr"
category: "General"
last_modified: "2026-02-27T13:14:54Z"
page_id: 10054
...
1. Lancez une session OnDemand sur votre bureau en cliquant sur le lien approprié.  NIBI : https://ondemand.sharcnet.ca
...
2. Sélectionnez un module COMSOL (par exemple comsol/6) dans la section Available Module de gauche.
3. Pour le module sélectionné, cliquez sur Load pour faire afficher l'icône Comsol (VNC) sur le bureau.
...
1. Avec un client VncViewer, connectez-vous à un nœud de calcul ou de connexion sans GPU, comme décrit dans TigerVNC.
...
Connectez-vous à Nibi, chargez Abaqus et exécutez une des commandes suivante&snbsp:
