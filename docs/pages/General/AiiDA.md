...
To allow AiiDA and other similar software to connect to Alliance clusters, we have set up so-called automation nodes on each cluster.  These allow SSH connections without MFA, subject to restrictions.
