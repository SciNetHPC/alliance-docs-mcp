...
Setting access policies cannot be done via a web browser but must be done with a SWIFT or S3-compatible client.  There are several ways to access your data containers:

# You can use an S3-compatible client (e.g. s3cmd).
# You can use Globus.
...
Our documentation provides specific instructions on configuring and managing access with the s3cmd client.
