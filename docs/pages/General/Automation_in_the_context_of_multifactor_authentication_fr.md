...
url: "https://docs.alliancecan.ca/wiki/Automation_in_the_context_of_multifactor_authentication/fr"
category: "General"
last_modified: "2026-02-20T19:35:02Z"
page_id: 24809
display_title: "Flux de travail automatisés et authentification multifacteur"
language: "fr"
---
...
Si c'est le cas, assurez-vous que le masque de l'adresse IP que vous entrez dans le champ restrict,from= de la clé corresponde au type d'adresse que votre ordinateur utilisera pour se connecter au nœud.
...
Si la connexion SSH à un nœud d'automatisation ne se fait pas, faites un test avec la commande
 ssh -i ~/.ssh/automation_key -vvv username@robot.rorqal.alliancecan.ca "ls -l"

Ceci essaie d'établir la connexion avec le nœud d'automatisation sur Rorqual et d'exécuter la commande ls -l avec la clé SSH
~/.ssh/automation_key.
La liste des fichiers contenus dans votre répertoire /home sur Rorqual est ensuite affichée.
...
Ceci établit la connexion au nœud d'automatisation de Rorqual avec une clé inscrite dans le portail CCDB et exécute la commande ls -l pour obtenir la liste des fichiers.
