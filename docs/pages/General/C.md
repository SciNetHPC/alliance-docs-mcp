...
# C, i.e., the language, history, C90.
# C99: Adds language and Standard Library features. int is no longer implicitly assumed.
# C11: Major release adding memory model and concurrency (e.g., threads, atomics, compare-and-swap) support.
