...
* Has daily backup
Scratch space 5.4PB total volumeParallel high-performance filesystem
* For active or temporary (scratch) storage.
* Not allocated.
* Large fixed quota per user.
* Inactive data will be purged.
Project space23PB total volumeExternal persistent storage
