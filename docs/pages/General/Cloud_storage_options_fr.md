...
url: "https://docs.alliancecan.ca/wiki/Cloud_storage_options/fr"
category: "General"
last_modified: "2024-07-15T20:19:29Z"
page_id: 20552
display_title: "Options de stockage infonuagique"
language: "fr"
---

Nos nuages offrent les types de stockage suivants :

*  Volume : unité de stockage infonuagique standard qui peut être attachée et détachée d’une instance.
...
*  Stockage objet :  stockage non hiérarchique pour les données créées ou téléversées sous forme de fichier complet.
*  Système de fichiers partagé : espace de stockage privé connecté au réseau (similaire aux partages NFS/SMB); doit être configuré sur chaque instance où il est monté.
