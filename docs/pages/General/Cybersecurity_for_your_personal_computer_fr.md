...
url: "https://docs.alliancecan.ca/wiki/Cybersecurity_for_your_personal_computer/fr"
category: "General"
last_modified: "2022-10-12T22:47:29Z"
page_id: 20859
display_title: "Cybersécurité de votre ordinateur personnel"
language: "fr"
---
...
Vous trouverez ici quelques conseils pour améliorer la sécurité de votre ordinateur. Nous avons aussi préparé ce court questionnaire pour vous permettre d’évaluer son niveau de sécurité.

== Mises à jour ==
Activez la fonction de mise à jour automatique du système d'exploitation et de vos applications.

Pour plus d’information, voir Mises à jour logicielles : pourquoi elles sont essentielles pour votre cybersécurité.

== Mots de passe ==
Utilisez des mots de passe robustes. Voyez Au sujet des mots de passe ci-dessous.
...
Pour plus d’information, voir Reconnaître les tentatives d'hameçonnage : comment se protéger.
...
Pour plus d'information, voir Réseaux privés et Réseaux Wi-Fi publics.
...
** facile aussi avec un gestionnaire si vous lui permettez de générer vos mots de passe. Un mot de passe de 20 à 32 caractères n'est pas un problème puisque le gestionnaire s'en souveint pour vous.
...
Nous pouvons choisir d'utiliser des outils de recherche qui protègent davantage la confidentialité comme DuckDuckGo (duckduckgo.com); installer des extensions de navigateurs comme  Privacy Badger (privacybadger.org), HTTPS Everywhere (eff.org/https-everywhere) ou uBlock Origin (ublockorigin.com). Nous pouvons configurer les navigateurs pour limiter l'usage de témoins (cookies) ainsi que les liens et les outils de traçage des compagnies de médias sociaux (mozilla.org/en-US/firefox/facebookcontainer).
...
Erreur no 1 : Permettre l'accès général à un fichier avec la commande chmod 777 name_of_file.

Assurez-vous de bien comprendre le fonctionnement des permissions Linux et de limiter l'accès à vos fichiers en cas de besoin seulement.

Erreur no 2 : Ignorer le sticky bit, ce qui peut mener à la suppression de vos fichiers par un autre utilisateur ou utilisatrice.

Dans le cas de fichiers partagés où plusieurs ont les permissions de lecture et d'écriture, il y a toujours le risque qu'une personne supprime les fichiers ou les répertoires d'une autre. Utilisez la la protection sticky bit quand elle est appropriée.

Erreur no 3 : Permettre l'accès à plusieurs personnes individuellement plutôt qu'à un groupe.

La gestion des listes de contrôle d'accès peut devenir rapidement complexe. La meilleure pratique est de donner des permissions à un groupe plutôt qu'à plusieurs personnes.