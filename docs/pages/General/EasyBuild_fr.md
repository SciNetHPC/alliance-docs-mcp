---
title: "EasyBuild/fr"
url: "https://docs.alliancecan.ca/wiki/EasyBuild/fr"
category: "General"
last_modified: "2023-09-14T16:50:48Z"
page_id: 18579
...
* EBROOT qui contient le chemin complet du répertoire où se trouve le logiciel
* EBVERSION qui contient la version complète du logiciel  chargé par le module
...
EasyBuild conserve une copie de la recette utilisée pour installer chaque paquet logiciel et un journal détaillé dans le répertoire d’installation  $EBROOT/easybuild. Par exemple, pour le module python/3.10.2, le répertoire d’installation contient, entre autres
...
* ---.eb
où  est le nom du paquet,  est la version du paquet,  est le nom de la chaîne de compilation et   est la version de la chaîne de compilation.
...
* Building software on Compute Canada clusters using EasyBuild, webinaire
* Documentation pour notre équipe technique
* Tutoriels