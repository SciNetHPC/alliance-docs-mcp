---
title: "FMRIPrep/fr"
url: "https://docs.alliancecan.ca/wiki/FMRIPrep/fr"
category: "General"
last_modified: "2023-11-02T19:39:41Z"
page_id: 24503
...
= Chargement =
fMRIPrep est une application NiPreps pour le prétraitement d'images au format BIDS obtenues par résonance magnétique. Pour utiliser fMRIPrep sur nos grappes, il faut d'abord charger le module.
...
Dans le conteneur, fMRIPrep voudra télécharger les gabarits TemplateFlow, mais sera incapable. Il aurait fallu télécharger ces données à l'avance avec
...
Si vous voulez utiliser FreeSurfer avec fMRIPrep, il faudra vous enregistrer avec FreeSurfer, télécharger le fichier de licence, copier ce fichier dans un des répertoires dans APPTAINER_BIND et utiliser l'option --fs-license-file. Nous n'irons pas dans les détails parce que nous avons confiance en vous!
