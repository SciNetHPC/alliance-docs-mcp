---
title: "Frequently Asked Questions about the CCDB/fr"
url: "https://docs.alliancecan.ca/wiki/Frequently_Asked_Questions_about_the_CCDB/fr"
category: "General"
last_modified: "2025-09-03T20:59:16Z"
page_id: 8743
display_title: "Foire aux questions sur le portail CCDB"
language: "fr"
---
...
CCDB est le portail pour votre compte avec l'Alliance. Vous y trouvez l'information sur les rôles qui sont vous sont désignés dans les projets auxquels vous participez, les ressources que vous pouvez utiliser et les statistiques sur votre utilisation de ces ressources.
...
Pour savoir comment ajouter des membres, consultez les caractéristiques des grappes.
...
L'Alliance a pour politique de n’attribuer qu’un compte (CCI) par personne. Les demandes concernant un second CCI sont donc automatiquement rejetées. Si vous avez déjà un CCI et avez changé de poste, demandez plutôt un nouveau rôle (CCRI). Pour cela, ouvrez votre compte et cliquez sur Mon compte --> Demander un nouvedau rôle. Si vous avez oublié votre mot de passe, vous pouvez le réinitialiser. Si vous n'avez plus accès à l'adresse courriel utilisée lors de votre première inscription, écrivez-nous à accounts@tech.alliancecan.ca et nous pourrons la mettre à jour pour vous.

== Comment puis-je m’inscrire? ==

Cliquez  ici pour vous enregistrer. Vous devrez accepter de vous conformer à certaines politiques et ententes avant d'obtenir votre compte. Vous pouvez prendre connaissance de ces documents sur notre site Web.
...
Voyez la liste complète des rôles.
