...
url: "https://docs.alliancecan.ca/wiki/Frequently_Asked_Questions/fr"
category: "General"
last_modified: "2026-02-06T20:01:02Z"
page_id: 5098
display_title: "Foire aux questions"
language: "fr"
---
...
*avec des fichiers texte Windows, lancer la commande dos2unix  sur un nœud de connexion pour convertir les caractères de fin de ligne au format approprié.
...
Vous pouvez savoir pourquoi vos tâches ont le statut PD (pending pour en attente), en exécutant la commande squeue -u .
...
À l'exécution, les paquets binaires précompilés qui sont installés dans votre répertoire $HOME peuvent produire une erreur semblable à /lib64/libc.so.6: version 'GLIBC_2.18' not found. Pour la solution, voir  Installer des paquets binaires.
