---
title: "Gaussian error messages/fr"
url: "https://docs.alliancecan.ca/wiki/Gaussian_error_messages/fr"
category: "General"
last_modified: "2022-07-19T22:43:17Z"
page_id: 6243
display_title: "Gaussian ː Messages d’erreur"
language: "fr"
---

:Page enfant de Gaussian
...
*votre quota a été dépassé (voir Quotas et politiques);
*le temps d’exécution a été plus long que le temps demandé à (voir l'ordonnanceur) (--time=HH:MM:SS);
*la mémoire demandée est insuffisante (voir Suivi des tâches); ou
...
Essayez d’obtenir un meilleur guess=read  (guess=read) en exécutant une procédure SCF avec la même structure de départ, mais avec un niveau théorique plus bas, par exemple HF/STO-3G.
