---
title: "Graham/fr"
url: "https://docs.alliancecan.ca/wiki/Graham/fr"
category: "General"
last_modified: "2025-09-23T22:16:02Z"
page_id: 1191
...
Graham est un système hétérogène adapté pour une grande variété de types de tâches; il est situé à l'Université de Waterloo. Son nom rappelle Wes Graham, premier directeur du Computing Centre de l'Université de Waterloo.
...
espace /homeVolume total de 133To
* localisation des répertoires /home
* chaque répertoire /home a un petit quota fixe
* non alloué via le service d'accès rapide ou le concours d'allocation de ressources; le stockage de grande envergure se fait sur l'espace /project
* est sauvegardé chaque jour
espace /scratchVolume total de 3.2PoSystème de fichiers parallèle de haute performance
* stockage /scratch actif ou temporaire
* non alloué
* grand quota fixe, par utilisateur
* les données inactives sont purgées
espace /project Volume total de 16PoStockage persistant externe
* allocations via le service d'accès rapide ou le concours d'allocation de ressources
...
Tous les nœuds de Graham sont dotés de la fonctionnalité Turbo Boost.
...
À compter du 13 janvier 2025, la capacité de Graham sera limitée à environ 25% jusqu'à ce que Nibi soit disponible.