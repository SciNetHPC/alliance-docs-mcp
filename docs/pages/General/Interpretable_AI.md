...
url: "https://docs.alliancecan.ca/wiki/Interpretable_AI"
category: "General"
...
1. Go to the IAI download page and download the latest release of IAI. Be sure to select "Linux" and the correct version of Julia (1.11.3 in these instructions).
