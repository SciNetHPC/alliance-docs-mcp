---
title: "MPI/fr"
url: "https://docs.alliancecan.ca/wiki/MPI/fr"
category: "General"
last_modified: "2024-11-04T20:16:01Z"
page_id: 1941
display_title: "MPI"
language: "fr"
---
...
Dans notre cas simple avec MPI_Send et MPI_Recv, le processus qui envoie doit connaitre le rang du processus qui reçoit et vice versa. Rappelons-nous des règles mathématiques suivantes :
...
Avec Open MPI, ces enveloppes ont l'option --showme qui imprime le nom du compilateur qui sera appellé et les options qui y seront ajoutées.
...
*variantes de MPI_Send/MPI_Recv
* communication collective
* communicateurs et topologies
* communication unilatérale et fonctionnalités de MPI-2
* types de données dérivés
* performance
* débogage
* tutoriel Boost MPI (en français)
