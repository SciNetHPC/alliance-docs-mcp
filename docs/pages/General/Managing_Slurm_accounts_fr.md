...
url: "https://docs.alliancecan.ca/wiki/Managing_Slurm_accounts/fr"
category: "General"
last_modified: "2025-08-29T15:33:11Z"
page_id: 20962
display_title: "Gestion des comptes Slurm"
language: "fr"
---

À chaque tâche soumise à l'ordonnanceur de tâches Slurm est associé un projet d’allocation scientifique (RAP pour Resource Allocation Project). Le RAP est sélectionné avec l’option --account de sbatch.
La priorité de la tâche sera déterminée par la part cible du compte comparée à l’utilisation récente, tel que décrit dans la Politique d'ordonnancement des tâches.
...
Si ces stratégies ne sont pas efficaces, contactez le soutien technique et demandez à l’analyste de consulter la documentation interne intitulée A group in conflict with itself.