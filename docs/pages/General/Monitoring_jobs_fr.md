...
url: "https://docs.alliancecan.ca/wiki/Monitoring_jobs/fr"
category: "General"
last_modified: "2025-05-30T07:29:34Z"
page_id: 28586
display_title: "Performance des tâches"
language: "fr"
---
...
Par défaut, squeue affiche toutes les tâches gérées par l'ordonnanceur à ce moment. L'exécution sera beaucoup plus rapide si vous n'incluez que vos propres tâches.
 $ squeue -u $USER
...
Pour l'information détaillée sur une tâche en particulier, utilisez  scontrol.
...
Pour la liste complète des options, voir la documentation de SchedMD.
...
Pour l'information détaillée sur une tâche qui est terminée, utilisez sacct; en option, il est possible de déterminer le contenu affiché avec --format.
 $ sacct -j
...
La commande sstat fournit des renseignements sur l'état d'une tâche en cours d'exécution et la commande  sacct est utilisée pour les tâches qui sont terminées.
...
Plusieurs commandes peuvent être lancées avec tmux. L'exemple suivant exécute htop et nvidia-smi dans des fenêtres distinctes pour faire le suivi de l'activité sur le nœud où la tâche est exécutée.
