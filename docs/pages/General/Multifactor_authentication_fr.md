...
url: "https://docs.alliancecan.ca/wiki/Multifactor_authentication/fr"
category: "General"
last_modified: "2026-02-17T07:48:01Z"
page_id: 22499
display_title: "Authentification multifacteur"
language: "fr"
---
...
#Installez l'application Duo Mobile à partir du Apple Store ou de  Google Play. Assurez-vous d'avoir la bonne application (voir l'icône ci-dessous). Les applications TOTP comme Aegis, Google Authenticator et Microsoft Authenticator ne sont pas compatibles avec Duo et ne peuvent pas balayer le code QR.
...
#Balayez le code QR qui est affiché dans CCDB. Important : Pour balayer le code QR, votre appareil doit avoir accès à l'internet par wi-fi ou par réseau cellulaire.
...
Pour enregistrer une YubiKey, entrez son identifiant public, son identifiant privé et sa clé secrète dans la page Gestion de l'authentification multifacteur. Si ces renseignements ne sont pas disponibles, configurez votre clé comme suit.

=== Configurer votre YubiKey pour Yubico OTP ===

# Téléchargez et installez YubiKey Authenticator à partir du site Web de Yubico.
# Insérez la clé YubiKey et lancez YubiKey Authenticator.
# Dans YubiKey Authenticator, cliquez sur Slots (voir les images ci-dessous).
...
# Sélectionnez Yubico OTP / Program a Yubico OTP credential.
# Dans le champ Public ID, cliquez sur Use serial pour générer un identifiant privé et une clé secrète. Faites une copie de Public ID, Private ID et de la clé secrète parce que vous en aurez besoin à la prochaine étape.
# IMPORTANT: Assurez-vous d'avoir cliqué sur Save.
# Connectez-vous à CCDB et cliquez sur Mon compte → Gestion de l'authentification multifacteur.

File:Yubico-Authenticator-Step3.png|Step Étape 3
File:Yubico-Authenticator-Step4.png|Étape 4, Étape 5
File:Yubico-Authenticator-Step6.png|Étape 6
File:Yubico-Authenticator-Step7.png|Étape 7
...
La version 23.5 (sur Archive.org) est la dernière version pour laquelle les instructions suivantes fonctionnent pour la plupart des gens.
...
faire afficher le contenu du répertoire dans le panneau de gauche
...
* Si vous avez configuré plusieurs appareils ou si vous avez généré des codes de contournement, utilisez une des méthodes suivantes pour  accéder à votre compte. Enregistrez tout nouvel appareil et supprimez celui que vous avez perdu. Si vous n'avez enregistré qu'un seul appareil, vous ne pouvez pas le supprimer.
* Si vous n’avez sauvegardé aucun code de contournement et que vous avez perdu tous les appareils que vous avez entrgistrés, copiez la liste suivante et ajoutez-y le plus de détails possible. Faites parvenir cette information à    support@tech.alliancecan.ca.
...
# Installez le logiciel de ligne de commande YubiKey Manager (ykman) en suivant les directives pour votre système d'exploitation dans  le  guide ykman.
