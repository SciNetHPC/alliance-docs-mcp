---
title: "Narval/fr"
url: "https://docs.alliancecan.ca/wiki/Narval/fr"
category: "General"
last_modified: "2025-12-16T19:16:21Z"
page_id: 17286
...
HOME  Système de fichiers Lustre, 64 To d’espace au total
...
SCRATCH  Système de fichiers Lustre, 5.7 Po d’espace au total
...
PROJECT  Système de fichiers Lustre, 35 Po d’espace au total
...
1145 	64   	250G ou 256000M   	2 x AMD EPYC 7532 (Zen 2) @ 2.40 GHz, 256M cache L3	1 x SSD de 960G
33   	64   	2009G ou 2057500M 	2 x AMD EPYC 7532 (Zen 2) @ 2.40 GHz, 256M cache L3	1 x SSD de 960G
3    	64   	4000G ou 4096000M 	2 x AMD EPYC 7502 (Zen 2) @ 2.50 GHz, 128M cache L3	1 x SSD de 960G
159  	48   	498G ou 510000M   	2 x AMD EPYC 7413 (Zen 3) @ 2.65 GHz, 128M cache L3	1 x SSD de 3.84T	4 x NVidia A100SXM4 (mémoire 40G), connectés via NVLink

===Particularités liées aux processeurs AMD===
====Ensemble d'instructions pris en charge====
La grappe Narval est équipée de processeurs AMD EPYC de 2e et 3e génération qui prennent en charge les instructions AVX2.

Narval ne prend toutefois pas en charge les instructions AVX512, contrairement aux nœuds de grappes plus récentes.
...
* Un A100-40gb : --gpus=a100:1
* Plusieurs A100-40gb par nœud :
** --gpus-per-node=a100:2
** --gpus-per-node=a100:3
** --gpus-per-node=a100:4
* Plusieurs A100-40gb éparpillés n'importe où : --gpus=a100:n (remplacer n par le nombre voulu)

Plusieurs nœuds GPU de Narval sont configurés avec la technologie MIG et quatre tailles d'instances GPU sont disponibles :
