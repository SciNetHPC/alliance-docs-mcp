...
#Ensure that the wiki code to be translated is enclosed within   tags.
#Ensure that the tag  appear at the very top of the page. This will show a box
...
Second, if you do have to make a change to a page that has been translated, make sure you do NOT change the tags of the form . Those are automatically generated.
