...
programmers would probably find the constructs in the Boost threading library or which are part of the C++11 standard to be more attractive options, given their consistency with object-oriented design.
