...
url: "https://docs.alliancecan.ca/wiki/RAC_transition_FAQ/fr"
category: "General"
last_modified: "2021-03-11T19:46:51Z"
page_id: 11026
display_title: "Période de transition des allocations"
language: "fr"
---
...
* Les utilisateurs sont responsables de déplacer leurs données avec Globus, scp, rsync, etc.; pour les détails, consultez  Transfert de données. L’équipe de soutien technique peut vous conseiller ou vous assister si les données à déplacer sont de 200To ou plus.
...
* L’équipe responsable de l’ordonnanceur prévoit archiver et compacter la base de données Slurm le 31 mars, avant l’implémentation des allocations qui se fera le 1 avril. Ces opérations devraient pouvoir s’effectuer au cours des heures creuses. Il est possible que la base de données ne réponde pas, particulièrement sacct et sacctmgr.
