---
title: "Scalability/fr"
url: "https://docs.alliancecan.ca/wiki/Scalability/fr"
category: "General"
last_modified: "2018-06-07T13:07:08Z"
page_id: 7235
display_title: "Scalabilité"
language: "fr"
---
...
Deuxièmement, la parallélisation requiert habituellement une certaine part de communication et de synchronisation entre les processus qui travaillent en parallèle; cette charge additionnelle est en quelque sorte un coût indirect qui augmente de façon non linéaire avec le nombre de cœurs exprimé par T_c \propto n^\alpha où \alpha > 1. Supposons maintenant que le temps d’exécution de la partie scientifique du programme est employé également par chacun des cœurs (sans compter la partie résiduelle en série) et que T_s = A + B/n; le facteur déterminant de la durée totale d’exécution T = T_s + T_c = A + B/n + C n^\alpha (où A, B et C sont des nombres réels positifs dont les valeurs dépendent de la grappe, du programme et du problème) sera ici le coût indirect de la parallélisation quand n\to\infty. Si A et B sont beaucoup plus grands que C, le temps d’exécution par rapport au nombre de cœurs suivra la courbe représentée ici.

Remarquez que la durée d’exécution diminue lorsqu’on utilise peu de cœurs, puis qu’un minimum est atteint autour de n\approx 22 et enfin que la durée augmente avec l’ajout de processus, donnant foi au proverbe trop de cuisiniers gâtent la sauce. Quand vous utilisez un programme parallèle, il est primordial d’effectuer une analyse de scalabilité semblable afin d’identifier le nombre optimal de cœurs CPU entre 4, 128, 1024 ou autre, selon la nature et la taille du problème et selon la grappe sur laquelle le programme est exécuté.
...
L’efficacité est le rapport de la durée d’exécution avec deux cœurs d’une part et n cœurs d’autre part, divisé par n/2 puis multiplié par 100. La valeur du pourcentage indique le niveau de scalabilité linéaire de la performance parallèle, c’est-à-dire que le fait de doubler le nombre de cœurs réduit de moitié la durée d’exécution, ce qui correspondrait à une efficacité de 100 %.

Dans le tableau, passer de 2 à 4 cœurs résulte en une efficacité de plus de 100 %, ce qu’on appelle superlinear scaling. Il s’agit d’un cas qui est rare, mais qui se produit habituellement quand la cache fonctionne de plus en plus efficacement et que chacun des cœurs travaille de moins en moins. https://en.wikipedia.org/wiki/Speedup#Super-linear_speedup
