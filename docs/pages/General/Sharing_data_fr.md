...
url: "https://docs.alliancecan.ca/wiki/Sharing_data/fr"
category: "General"
last_modified: "2025-08-29T16:18:18Z"
page_id: 2557
display_title: "Partage de données"
language: "fr"
---
...
Pour positionner les permissions  rwxrwxr-- et le stickly bit sur un répertoire, utilisez la commande chmod ainsi
...
Le bit setUID ne fonctionne pas sur nos grappes.
...
où  est une valeur octale. Le tableau suivant montre des options utiles de umask.
...
; Note: L'attribut X (majuscule) donne la permission execute seulement quand le répertoire ou le fichier possède déjà la permission d'exécution. Pour pouvoir être vu, un répertoire doit avoir la permission d'exécution.

La première commande détermine les règles d'accès au répertoire /home//projects/def-/shared_data; tous les fichiers et répertoires qui y seront créés hériteront de la même règle ACL. Elle est nécessaire pour les  nouvelles données. La deuxième commande détermine les règles ACL pour le répertoire /home//projects/def-/shared_data et tout le contenu actuel. Elle ne s'applique qu'aux données existantes.
