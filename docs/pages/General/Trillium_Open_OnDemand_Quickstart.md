...
IMPORTANT: Because of the change of operating system and software stack, your existing virtual environment kernels for Python may not work right away in the OnDemand site. You should be able to activate your Python environments in a Trillium terminal (see below Terminal access), with all required Trillium modules loaded, and then issue the command venv2jup to get them working correctly.
