...
More details on best practices can be found  here.
...
Grab the content of your public key (called id_rsa.pub in the above case) and upload it to CCDB as per step 3 of these instructions.
