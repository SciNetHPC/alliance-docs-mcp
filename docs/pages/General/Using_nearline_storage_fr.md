...
url: "https://docs.alliancecan.ca/wiki/Using_nearline_storage/fr"
category: "General"
last_modified: "2026-01-21T14:02:03Z"
page_id: 9569
display_title: "Stockage /nearline"
language: "fr"
---
...
Utilisez tar ou dar pour créer un fichier archive.
...
#   se trouve seulement sur disque.
$ lfs hsm_state
:  (0x00000000)

#  est présentement copié sur ruban.
$ lfs hsm_state
: [...]: exists, [...]

#  se trouve à la fois sur disque et sur ruban.
$ lfs hsm_state
: [...]: exists archived, [...]

#  se trouve sur ruban et n'est plus sur disque; ouvrir ce fichier prendra plus de temps.
$ lfs hsm_state
: [...]: released exists archived, [...]

Vous pouvez forcer le rappel d'un fichier sur ruban sans le lire avec la commande lfs hsm_restore .
...
3. Utilisez Globus pour transférer vos fichiers HPSS avec le point de chute (endpoint) alliancecan#hpss. Cette méthode est utile pour un usage occasionnel ou pour les transferts entre HPSS et les autres sites.