...
== AVX-512 Limitations ==
Note that current versions of Valgrind are unable to handle the AVX-512 instructions used on the latest Intel and AMD processors, producing an error message like the following,
