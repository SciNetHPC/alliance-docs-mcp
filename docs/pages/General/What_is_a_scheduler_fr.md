...
url: "https://docs.alliancecan.ca/wiki/What_is_a_scheduler%3F/fr"
category: "General"
last_modified: "2023-07-21T18:00:01Z"
page_id: 3750
display_title: "Qu'est-ce qu'un ordonnanceur?"
language: "fr"
---
...
Suite à la commande sq, la colonne ST (state) indique l'état de la tâche (voir la section Suivi des tâches dans Exécuter des tâches). Les états les plus communs sont PD (pending) pour en attente, et R (running) pour en cours. Si la tâche est complétée, la colonne ST (state) est vide.
