...
url: "https://docs.alliancecan.ca/wiki/Installing_software_in_your_home_directory/fr"
category: "Getting Started"
last_modified: "2025-11-03T20:44:38Z"
page_id: 2988
display_title: "Installation de logiciels dans votre répertoire /home"
language: "fr"
---

La plupart des logiciels utilisés en recherche sont disponibles gratuitement sur Internet. Vous pouvez nous demander d'installer des logiciels que vous pourrez ensuite utiliser avec la commande module load (voir Utiliser les modules); pour ce faire, écrivez à support@tech.alliancecan.ca en joignant l'adresse URL pour l'installation. Si les clauses de la licence et les exigences techniques le permettent, le logiciel sera rendu disponible le plus tôt possible.
...
Le module gentoo/2023 est chargé par défaut et agit comme cœur pour cette pile logicielle qui est gérée par le gestionnaire de paquets Gentoo situé sous /cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr. Pour référer à ce chemin, utilisez la variable d'environnement $EBROOTGENTOO.
