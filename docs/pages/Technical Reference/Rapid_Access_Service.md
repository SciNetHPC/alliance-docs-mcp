...
Fir, Nibi, Rorqual, Narval	Max 40 TB

across all clusters	Max 100 TB
...
== Cloud resources ==
Access to modest amounts of cloud resources, within the limits detailed in the cloud RAS documentation, can be requested at any time.  PIs must complete this form with details about cloud resource needed.
