...
url: "https://docs.alliancecan.ca/wiki/A_tutorial_on_%27tar%27/fr"
category: "User Guide"
last_modified: "2020-12-10T21:38:35Z"
page_id: 11789
display_title: "Tutoriel : Archivage et compression avec <tt>tar</tt>"
language: "fr"
---
...
De façon générale, --xz produit un fichier compressé plus petit (c'est-à-dire avec un meilleur taux de compression), mais utilise plus de mémoire RAM.
...
Note : Pour lister les fichiers dans une archive ou dans un fichier compressé, vous pouvez aussi utiliser la commande more après le trait vertical.
...
À partir de votre terminal, utilisez la commande du -sh [your_file ...].
...
* pwd montre le chemin de travail courant (pwd pour present work directory)
...
* Compresser un fichier (file0) ou des fichiers (file1 file2 file3 file4 file5) dans un fichier archive (your_archive.tar) avec la commande gzip :
...
* Compresser un fichier (file0) ou des fichiers (file1 file2 file3 file4 file5) dans un fichier archive (your_archive.tar) avec la commande bzip2  :
...
[user_name@localhost]$ split -b . prefix-name
